...
BT::NodeStatus NavigateToPose::tick()
{
    ...
    RCLCPP_INFO(rclcpp::get_logger("NavigateToPose"), "Sending navigation goal: %s", goal.value().c_str());
    ...
    {
        RCLCPP_ERROR(rclcpp::get_logger("NavigateToPose"), "NavigateToPose action server not available!");
    ...
    {
        RCLCPP_ERROR(rclcpp::get_logger("NavigateToPose"), "Failed to send goal!");
        return BT::NodeStatus::FAILURE;
    }
    ...
    {
        RCLCPP_ERROR(rclcpp::get_logger("NavigateToPose"), "Failed to get result!");
        return BT::NodeStatus::FAILURE;
    }
